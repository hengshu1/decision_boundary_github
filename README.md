...
5. Run `python plot_cat_dog_in_PCA2.py' to plot the cat and dog samples in the PCA(2) space. This is simpler version of Fig1 without the background plotting. 
